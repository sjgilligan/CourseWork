...
for i = 1:height(resp.Countries)
   if resp.Countries.CountryCode == code
       data = struct(Name = resp.Countries(i).Name,TotalConfirmed = resp.Countries(i).TotalConfirmed,TotalDeaths = resp.Countries(i).TotalDeaths);
   end
end

//Sebastian Gilligan EC444 Used sample code provided, filled in functions
/*
...
dataRate_t getDataRate(void) {
  return (dataRate_t)(readRegister(ADXL343_REG_BW_RATE) & 0x0F); //changed period -> rate
}
...
void calcRP(float x, float y, float z){ //USED CHATGPT
  // YOUR CODE HERE
